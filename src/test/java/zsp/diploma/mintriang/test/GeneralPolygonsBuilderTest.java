...
import zsp.diploma.mintriang.algorithm.step.impl.GeneralPolygonsBuilderImpl;
...
public class GeneralPolygonsBuilderTest extends BaseTest {
    ...
    private void testGeneralPolygonsKruskal(List<Point> points, List<List<Point>> expectedPoints, Integer... edges)
        ...
        GeneralPolygonsBuilderImpl generalPolygonsBuilderImpl = new GeneralPolygonsBuilderImpl();
        Hull convexHull = convexHullBuilderImpl.buildConvexHull(geometryFactory, points);
        List<GeneralPolygon> generalPolygons = generalPolygonsBuilderImpl.buildGeneralPolygons(geometryFactory, convexHull);
