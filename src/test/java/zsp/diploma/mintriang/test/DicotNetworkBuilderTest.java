...
import zsp.diploma.mintriang.algorithm.step.impl.DicotNetworkBuilderImpl;
...
public class DicotNetworkBuilderTest extends BaseTest {

    private void testIntersectionGraph(
            Triangulation triangulation1, Triangulation triangulation2)
            throws TriangulationException {

        DicotNetworkBuilderImpl dicotNetworkBuilderImpl = new DicotNetworkBuilderImpl();
        DicotNetwork network = dicotNetworkBuilderImpl.buildDicotNetwork(geometryFactory, triangulation1, triangulation2);
