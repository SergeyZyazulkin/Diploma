...
public class ConvexHullBuilderTest extends BaseTest {
    ...
    private void testGrahamScan(List<Point> points, List<Edge> expectedEdges) throws TriangulationException {
        ...
        Hull hull = convexHullBuilderImpl.buildConvexHull(geometryFactory, points);
        visualize((Triangulation) hull);
        Assert.assertTrue(equal(hull.getEdges(), expectedEdges));
    }
