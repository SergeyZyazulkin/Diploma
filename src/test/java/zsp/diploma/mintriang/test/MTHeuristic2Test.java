...
public class MTHeuristic2Test extends BaseTest {

    private void testHeuristic2(
        ...
        Triangulation triangulation = mtHeuristic2.triangulate(points);
    ...
    public void testRandom() throws TriangulationException {
        List<Point> points = getRandomPoints(1000);
        testHeuristic2(points, null);
    }
}
