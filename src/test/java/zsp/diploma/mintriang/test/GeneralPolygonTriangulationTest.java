...
public class GeneralPolygonTriangulationTest extends BaseTest {
    ...
    private void testGeneralPolygonTriangulation(
        ...
        GeneralPolygonTriangulation generalPolygonTriangulation = new GeneralPolygonTriangulation();
        ...
        Triangulation triangulation = generalPolygonTriangulation.buildTriangulation(geometryFactory, generalPolygon);
    ...
    public void testNotEnoughPoints() throws TriangulationException {
        ...
        testGeneralPolygonTriangulation(points, null);
    }
