...
public class ConvexHullBuilderImpl implements ConvexHullBuilder {

    private Point min;

    @Override
    public Hull buildConvexHull(GeometryFactory geometryFactory, List<Point> points)
    ...
    private Hull buildConvexHull(GeometryFactory geometryFactory, List<Point> points, int pointsOnConvexHull) {
        ...
        return geometryFactory.createHull(boundaryPoints, points, edges);
    }
}
