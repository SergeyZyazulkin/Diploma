...
public interface ConvexGeneralPolygonBuilder {

    GeneralPolygon buildGeneralPolygon(GeometryFactory geometryFactory, Hull convexHull) throws TriangulationException;
}
